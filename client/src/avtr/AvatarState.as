package avtr
{
	...
	{	
		...
		public function update(keys:Object):void{throw new Error("unninplemented")};
		...
		public function resolveDirection(keys:Object):Vector2D
		{
			var xdir:Number = keys[Keyboard.LEFT] ? -1 : 0 + keys[Keyboard.RIGHT] ? 1 : 0;
			var ydir:Number = keys[Keyboard.UP] ? -1 : 0; // + keys[Keyboard.DOWN] ? 1 : 0;
